  ...
  <div class="col-12">
      <div class="card border-success">
          ...
          <div class="card-body">
            ...
            <form action="<?= base_url('hallaporan/laporanpenjualan') ?>" method="post" target="new">
            <div class="row mb-2">
              <label class="col-4"><b>Laporan Penjualan</b> </label>
              <div class="col-3">
                <input class="form-control" type="date" name="inputan_tgl_terjual" required>
                <small><b>Tgl. Mulai</b></small>
              </div>
              <div class="col-3">
                <input class="form-control" type="date" name="inputan_tgl_masuk" required>
